...
export default function renderAndDownload(name) {
    ...
    const interval = setInterval(()=>{console.log(picoAudioRender.context.currentTime)},250)
    picoAudioRender.render().then(buffer => {
